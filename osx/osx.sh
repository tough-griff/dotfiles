...
sudo scutil --set ComputerName "hermes"
sudo scutil --set HostName "hermes"
sudo scutil --set LocalHostName "hermes"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "hermes"
...
# Spectacle.app                                                               #
###############################################################################
defaults write com.divisiblebyzero.Spectacle MakeLarger -data 
defaults write com.divisiblebyzero.Spectacle MakeSmaller -data 
...
for app in "Activity Monitor" "Address Book" "Calendar" "cfprefsd" "Contacts" \
	"Dock" "Finder" "Google Chrome Canary" "Google Chrome" "iCal" "Mail" \
	"Messages" "Photos" "Safari" "Spectacle" "SystemUIServer" "Terminal" \
	"Transmission"; do
