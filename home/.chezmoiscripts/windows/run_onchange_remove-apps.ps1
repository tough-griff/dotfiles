...
$Junk = "549981C3F5F10|Clipchamp|Copilot|Bing|GetHelp|NarratorScript|MicrosoftOfficeHub|MicrosoftSolitaireCollection|MicrosoftStickyNotes|OneDrive|Todos|DevHome|People|Photos|WindowsAlarms|WindowsCalculator|WindowsCamera|WindowsCommunicationsApps|WindowsFeedbackHub|WindowsMaps|YourPhone|Zune|MSTeams|QuickAssist"
